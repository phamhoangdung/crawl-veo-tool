...
| 9. Compliance & value-add cho re-up | [docs/phases/phase-9-reup-compliance.md](docs/phases/phase-9-reup-compliance.md) | **Phần lõi xong & verify thật** — media overlay (logo/watermark/intro/nhạc nền) + sinh metadata SEO; thiếu UI chọn file và source ledger |
