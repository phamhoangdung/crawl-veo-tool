...
| 22. Theo dõi kênh + gợi ý video liên quan/cùng kênh (trong popup xem trước) | [docs/phases/phase-22-channel-follow.md](docs/phases/phase-22-channel-follow.md) | **Xong & verify thật qua browser** (2026-09-23) — sự cố cổng 8000 đã hết; popup, follow/unfollow, dải gợi ý, suy giảm khi risk-control đều verify bằng dữ liệu Bilibili thật. Field `space/wbi/arc/search` vẫn chưa verify được (100% bị risk-control chặn, đúng dự đoán) |
