...
| 20. Gộp "Xu hướng" + "Tìm & tải" thành một màn Khám phá | [docs/phases/phase-20-discovery-workspace.md](docs/phases/phase-20-discovery-workspace.md) | **Code xong, verify chắc qua test suite** (538 backend + 219 frontend pass) — phần verify qua browser/curl **không chắc chắn 100%** do máy dev có 2 tiến trình "ma" cùng chiếm cổng 8000 không kill được (xem "Ghi chú phát sinh"), cần verify lại sau khi khởi động lại máy sạch |
