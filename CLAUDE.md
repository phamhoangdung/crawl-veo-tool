...
| 1. Crawl & Trend Discovery (Bilibili) | [docs/phases/phase-1-crawl-bilibili.md](docs/phases/phase-1-crawl-bilibili.md) | Backend xong (verify API thật) — còn Frontend UI + test tải thật (cần ffmpeg) |
